...
echoInstallErr "安装提示","未安装","你的网站还未安装，请先安装"
end  if
Const S_Charset="gb2312"
Const S_Codepage=936
setcharset()
...
function setcharset()
	dim codepage_,Charset_
	Charset_=Charset
	codepage_=S_codepage
	if isExistStr(Request.ServerVariables("script_name"),adminPath) then Charset_=S_Charset
	if Charset_<>S_Charset then codepage_=65001

	Response.Charset = Charset_
	Response.codepage = codepage_
	session.codepage = codepage_
end function
Class SettingClass
...
Class TemplateClass
	...
	Public Function parseGlobal()		
		...
		dim cnzzstr:cnzzstr="":	if not isnul(CNZZUSER) then cnzzstr="<div style=''><script src='http://w.cnzz.com/c.php?id="&split(CNZZUSER,"@")(0)&"&l=2' language='JavaScript' charset='gb2312'></script></div>"
