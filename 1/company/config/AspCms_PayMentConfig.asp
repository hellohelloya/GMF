...
'服务器异步通知页面路径
Const notify_url = "http://demo.aspcms.com/order/alipay/notify_url.asp"
        '需http://格式的完整路径，不能加?id=123这类自定义参数

        '页面跳转同步通知页面路径
Const return_url = "http://demo.aspcms.com/order/alipay/return_url.asp"
Const Payment_Online="支付宝"
Const Payment_Bank="工商银行"
Const Payment_PostOffice="邮局付款说明"
%>