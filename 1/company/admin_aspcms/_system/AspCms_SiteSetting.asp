...
<TBODY>
    ...
    <TR class=list>
        ...
        <TD>网站编码 : </TD>
        <TD width=568>
        <input type="radio" name="Charset" disabled  value="utf-8" <% if Charset="utf-8" then echo"checked" end if %>>utf-8
        <input type="radio" name="Charset" value="gb2312" <% if Charset="gb2312" then echo"checked" end if %>>gb2312&nbsp;&nbsp;<a href="http://www.aspcms.com/article-5-1.html" style="color:#AAAAAA" target="_blank">网站状态作用说明</a>       </TD>
    </TR>
    <TR class=list>
        <TD>网站状态 : </TD>
        <TD width=568>
    ...
    <TR class=list>
        ...
        <TD><input type="radio" value="1" name="Share" <% if Share=1 then echo "checked" end if%>>开启
            <input type="radio" value="0" name="Share" <% if Share=0 then echo "checked" end if%>>关闭 <img src="../images/help.gif" class="tTip" title="打开后网页内显示一键分享，选择文章内容也会显示">调用标签:{aspcms:onekeyshare}</TD>
    </TR>
    <TR class=list>
        <TD>过滤设置开关 : </TD>
   ...
   <TR class="list water">
    ...
    <TR>
        ...
        <TD class=innerbiaoti align="right">&nbsp;&nbsp;<a href="http://www.aspcms.com/article-3-1.html" style="color:red" target="_blank">CNZZ全景统计申请和设置</a>&nbsp;&nbsp;</TD>
    </TR>   
    <TR class=list>
        <TD>CNZZ参数值 : </TD>
