...
<table width="100%" border="0" align="center" cellpadding="10" cellspacing="1" bgcolor="#cad9ea" >
  <tr>
    ...
    <td bgcolor="#FFFFFF" class="main_bright"><%=aspcmsVersion%> （<span id="version">暂时没有可升级文件<a href="http://www.aspcms.com/aspcms-2441-1-1.html" target="_blank">查看更新</a></span>）</td>
  </tr>
  <tr>
